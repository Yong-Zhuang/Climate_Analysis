...
def ResNet(input_shape=None, block='bottleneck', residual_unit='v1', repetitions=None,
    ...
    for i, r in enumerate(repetitions):
        ...
        filters *= 2
        print (str(i)+' block:'+ str(block.shape))
...
def ResNet4(input_shape,pooling,dropout=None,input_tensor=None):
    """ResNet with 18 layers and v2 residual units
    """
    return ResNet(input_shape, basic_block, repetitions=[1],initial_pooling=pooling,final_pooling=pooling,dropout=dropout)
...
def ResNet34(input_shape,pooling,dropout=None,input_tensor=None):
...
def ResNet50(input_shape,pooling,dropout=None,input_tensor=None):
...
def ResNet101(input_shape,pooling,dropout=None,input_tensor=None):
...
def ResNet152(input_shape,pooling,dropout=None,input_tensor=None):
...
def net(o_conf=(15, 1, 32, 32),f_conf=(15, 1, 32, 32), external_dim=5,mode=18):#121 169 201 264 161
   ...
   # external_output = Activation('relu')(h2)
    ...
    model = Model(inputs=[res_net0.input,res_net1.input,res_net2.input,x3], outputs=f)   
...
def net_mt_v1(o_conf=(15, 1, 32, 32),f_conf=(15, 1, 32, 32), external_dim=5,mode=18):#121 169 201 264 161
    ...
    input_fusion = add([input1, input2])
    pl = 'non'
    dp = None
    if mode==4:
        res_net0 = ResNet4(input_shape=o_shape, pooling=pl,dropout=dp)
...
def net_v1(o_conf=(15, 1, 32, 32),f_conf=(15, 1, 32, 32), external_dim=5,mode=18):#121 169 201 264 161
    lead, f_channels, f_height, f_width = f_conf
    look, o_channels, o_height, o_width = o_conf
    o_shape = (o_channels* look , o_height, o_width)
    f_shape = (f_channels* lead, f_height, f_width)
    ...
    q,o,f,out = fusion.net(x0,x1,x2,input3)
   ...
   # external_output = Activation('relu')(h2)
    ...
    model = Model(inputs=[res_net0.input,res_net1.input,res_net2.input,input3], outputs=[q,o,f,out])   
...
def net_v2(o_conf=(15, 1, 32, 32),f_conf=(15, 1, 32, 32), external_dim=5,mode=18):#121 169 201 264 161
    ...
    if mode==4:
        ...
        res_net0_0 = ResNet18(input_tensor=input0_0, pooling=pl,dropout=dp)
        res_net0_1 = ResNet18(input_tensor=input0_1, pooling=pl,dropout=dp)
        res_net0_2 = ResNet18(input_tensor=input0_2, pooling=pl,dropout=dp)
        res_net1_0 = ResNet18(input_tensor=input1_0, pooling=pl,dropout=dp)
        res_net1_1 = ResNet18(input_tensor=input1_1, pooling=pl,dropout=dp)
        res_net2_0 = ResNet18(input_tensor=input2_0, pooling=pl,dropout=dp)
        res_net2_1 = ResNet18(input_tensor=input2_1, pooling=pl,dropout=dp)
    elif mode==34:
        res_net0 = ResNet34(input_shape=o_shape, pooling=pl,dropout=dp)
        res_net1 = ResNet34(input_shape=f_shape, pooling=pl,dropout=dp)
        res_net2 = ResNet34(input_shape=f_shape, pooling=pl,dropout=dp)
        ...
        res_net1 = ResNet152(input_shape=f_shape, pooling=pl,dropout=dp)
        res_net2 = ResNet152(input_shape=f_shape, pooling=pl,dropout=dp)
    for layer in res_net0_0.layers:
      layer.name = layer.name + str("_0_0")
      layer.trainable = True
    x0_0 = res_net0_0.output
    for layer in res_net0_1.layers:
      layer.name = layer.name + str("_0_1")
      layer.trainable = True
    x0_1 = res_net0_1.output
    for layer in res_net0_2.layers:
      layer.name = layer.name + str("_0_2")
      layer.trainable = True
    x0_2 = res_net0_2.output
    for layer in res_net1_0.layers:
      layer.name = layer.name + str("_1_0")
      layer.trainable = True
    x1_0 = res_net1_0.output
    for layer in res_net1_1.layers:
      layer.name = layer.name + str("_1_1")
      layer.trainable = True
    x1_1 = res_net1_1.output
    for layer in res_net2_0.layers:
      layer.name = layer.name + str("_2_0")
      layer.trainable = True
    x2_0 = res_net2_0.output
    for layer in res_net2_1.layers:
      layer.name = layer.name + str("_2_1")
      layer.trainable = True
    x2_1 = res_net2_1.output
    #print (x1.shape)
    x3 = Input((external_dim,))
    
    f = fusion.net_v5(x0_0,x0_1,x0_2,x1_0,x1_1,x2_0,x2_1,x3)
   ...
   # external_output = Activation('relu')(h2)
    ...
    model = Model(inputs=[input0_0,input0_1,input0_2,input1_0,input1_1,input2_0,input2_1,x3], outputs=f)   
