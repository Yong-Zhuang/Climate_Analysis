...
def get_samples(lead,look,is3d,normalization):
    ...
    #else:
    X_tr = [Pob[0:train_validate],Px_mean[0:train_validate],Px_spread[0:train_validate],Qx_Ganges[0:train_validate],Qx_Brahmaputra[0:train_validate],Qx_Meghna[0:train_validate]] 
    #X_val = [Px_mean[test_train:train_validate],Px_spread[test_train:train_validate],Qx[test_train:train_validate]] 
    X_te = [Pob[train_validate:],Px_mean[train_validate:],Px_spread[train_validate:],Qx_Ganges[train_validate:],Qx_Brahmaputra[train_validate:],Qx_Meghna[train_validate:]]
