...
def net(conf,nlags,kernel_size,is_3D=False):
    ...
    #    m4 = Dropout(0.5)(m4)            
        ...
        conv22 = Conv2D(32, kernel_size, activation = 'relu', padding = 'same', data_format = 'channels_first',kernel_initializer=my_init)(conv12)
        ...
        conv32 = Conv2D(16, kernel_size, activation = 'relu', padding = 'same', data_format = 'channels_first',kernel_initializer=my_init)(conv22)
