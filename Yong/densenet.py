...
def net(o_conf=(15, 1, 32, 32),f_conf=(15, 1, 32, 32), external_dim=5,mode=121):#121 169 201 264 161
    ...
    pl = 'max'
    if mode==121:
        dense_net0 = DenseNetImageNet121(input_shape=(look * o_channels, o_height, o_width),
                                         pooling=pl)
        dense_net1 = DenseNetImageNet121(input_shape=(lead * f_channels, f_height, f_width),
                                         pooling=pl)
        dense_net2 = DenseNetImageNet121(input_shape=(lead * f_channels, f_height, f_width),
                                         pooling=pl)
    elif mode==169:
        dense_net0 = DenseNetImageNet169(input_shape=(look * o_channels, o_height, o_width),
                                         pooling=pl)
        dense_net1 = DenseNetImageNet169(input_shape=(lead * f_channels, f_height, f_width),
                                         pooling=pl)
        dense_net2 = DenseNetImageNet169(input_shape=(lead * f_channels, f_height, f_width),
                                         pooling=pl)
    elif mode==201:
        dense_net0 = DenseNetImageNet201(input_shape=(look * o_channels, o_height, o_width),
                                         pooling=pl)
        dense_net1 = DenseNetImageNet201(input_shape=(lead * f_channels, f_height, f_width),
                                         pooling=pl)
        dense_net2 = DenseNetImageNet201(input_shape=(lead * f_channels, f_height, f_width),
                                         pooling=pl)
    elif mode==264:
        dense_net0 = DenseNetImageNet264(input_shape=(look * o_channels, o_height, o_width),
                                         pooling=pl)
        dense_net1 = DenseNetImageNet264(input_shape=(lead * f_channels, f_height, f_width),
                                         pooling=pl)
        dense_net2 = DenseNetImageNet264(input_shape=(lead * f_channels, f_height, f_width),
                                         pooling=pl)
    else:
        dense_net0 = DenseNetImageNet161(input_shape=(look * o_channels, o_height, o_width),
                                         pooling=pl)
        dense_net1 = DenseNetImageNet161(input_shape=(lead * f_channels, f_height, f_width),
                                         pooling=pl)
        dense_net2 = DenseNetImageNet161(input_shape=(lead * f_channels, f_height, f_width),
                                         pooling=pl)
...
def net_mt(o_conf=(15, 1, 32, 32),f_conf=(15, 1, 32, 32), external_dim=5,mode=18):#121 169 201 264 161
    ...
    dp = None
    if mode==121:
        dense_net0 = DenseNetImageNet121(input_shape=o_shape,
                                         pooling=pl)
        dense_net1 = DenseNetImageNet121(input_shape=f_shape,
                                         pooling=pl)
        dense_net2 = DenseNetImageNet121(input_shape=f_shape,
                                         pooling=pl)
    elif mode==169:
        dense_net0 = DenseNetImageNet169(input_shape=o_shape,
                                         pooling=pl)
        dense_net1 = DenseNetImageNet169(input_shape=f_shape,
                                         pooling=pl)
        dense_net2 = DenseNetImageNet169(input_shape=f_shape,
                                         pooling=pl)
    elif mode==201:
        dense_net0 = DenseNetImageNet201(input_shape=o_shape,
                                         pooling=pl)
        dense_net1 = DenseNetImageNet201(input_shape=f_shape,
                                         pooling=pl)
        dense_net2 = DenseNetImageNet201(input_shape=f_shape,
                                         pooling=pl)
    elif mode==264:
        dense_net0 = DenseNetImageNet264(input_shape=o_shape,
                                         pooling=pl)
        dense_net1 = DenseNetImageNet264(input_shape=f_shape,
                                         pooling=pl)
        dense_net2 = DenseNetImageNet264(input_shape=f_shape,
                                         pooling=pl)
    else:
        dense_net0 = DenseNetImageNet161(input_shape=o_shape,
                                         pooling=pl)
        dense_net1 = DenseNetImageNet161(input_shape=f_shape,
                                         pooling=pl)
        dense_net2 = DenseNetImageNet161(input_shape=f_shape,
                                         pooling=pl)
    for layer in dense_net0.layers:
      layer.trainable = True
    x0 = dense_net0.output
    ...
    f = fusion.net_mt1(x0,x1,x2,x3,x4,x5)
   ...
   # external_output = Activation('relu')(h2)
    ...
    model = Model(inputs=[dense_net0.input,dense_net1.input,dense_net2.input,x3,x4,x5], outputs=f)   
    #model.summary()
